...
<h2>TRANG ĐĂNG NHẬP</h2>
            ...
            <div class="card-body px-lg-5 py-lg-5" style="  height:450;">
...
?> 
  ...
  width:100%;
  height:50;
" name="btnLogin">ĐĂNG NHẬP</button><br><br>
<br><br><br>
  <button style="  
      color: #ff8d00;
    background-color: #fff;
  ...
  width:40%;
  height:40;" type="submit"><a  href="/dang-ky/">Đăng Ký</a>
             </button>    <code>&nbsp;&nbsp;&nbsp;</code>
    ...
    border-color: #007cff;
  width:40%;
  height:40;" type="submit"><a  href="#baoloi">báo lỗi</a>
             </button>
