...
-- Thời gian đã tạo: Th8 31, 2021 lúc 07:42 AM
...
(1, '0138645729', 'tuanori', 'VIETTEL', 10000, 8200, '2021-08-31 06:35:35', '2021-08-31 06:35:48', 'thatbai', 'Thẻ không hợp lệ hoặc đã được sử dụng.', 'cardvip', '09181918181', '0918191818112', NULL, NULL, 0);
...
(1, 'tenweb', 'Tuấn Ori - Nhận Làm Website Uy Tín Giá Rẻ'),
(2, 'mota', 'Tuấn Ori - Nhận Làm Website Uy Tín Giá Rẻ'),
(3, 'tukhoa', 'Tuấn Ori - Nhận Làm Website Uy Tín Giá Rẻ'),
(4, 'logo', ''),
(5, 'email', ''),
(6, 'pass_email', ''),
...
(61, 'status_cardvip', 'ON'),
(62, 'api_cardvip', '416fdccf-439f-48cc-9355-2a853cef7c14');
...
INSERT INTO `users` (`id`, `username`, `password`, `token`, `money`, `level`, `banned`, `createdate`, `email`, `ref`, `ref_click`, `reason_banned`, `agency`, `otp`, `ip`, `time`, `used_money`, `total_money`, `phone`, `fullname`) VALUES
(1, 'tuanori', '8be9afa4ac293015623c5711cccbf30f', 'tKbHCfznpeuVrBGcFmUxNgZjdWMETQwOkLIiYPRXlosqyaSJDvhA', 0, 'admin', 0, '2021-08-31 06:30:03', 'tuanchopem@gmail.com', '', 0, NULL, 0, NULL, '116.96.76.140', '1630366203', 0, 0, NULL, NULL);
